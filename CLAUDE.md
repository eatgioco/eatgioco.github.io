...
obrigacoes            — MOTOR DE OBRIGAÇÕES, Fase 1 (Set/2026). Escrito SÓ pela
                         ...
                         nunca escreve por cima) }. O RTDB descarta nulls:
...
projetos              — projetos/{pushId} = { nome, estado ('ativo' | 'concluido' |
                         ...
                         update({ estado:'anulado', anulado:true, anuladoEm }) — os
                         passos abertos NÃO são anulados: passam a soltas na vista até
                         serem concluídos/anulados um a um. NUNCA remove().
