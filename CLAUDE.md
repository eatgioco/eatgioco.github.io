...
- **Excepção à excepção: a `calendario.html` tem `@media` próprios** (Set/2026, a única
  página do OS que os tem). Um calendário não se reorganiza só com `shell-touch`: ao
