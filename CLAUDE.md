...
caixaMovimentos       — movimentos de caixa física. Campos novos (Set/2026, chaves
                         ...
                         fase ('post'|'poll'|'analise'|null), tipo ('rede'|'servico'|
                         'leitura'), mensagem, corpo (até 2000 chars da resposta do
                         Azure, ou null), duracaoMs, ficheiroTipo, ficheiroBytes,
                         timestamp (ISO) } — escrito pela caixa.html com
                         ...
                         três tipos na mensagem (sem ligação / serviço recusou —
