...
suppliers             — fornecedores. Campos (compras.html): nome, categoria, contacto,
                         ...
                         não tem — um nif diferente do lido NUNCA é sobrescrito, fica o
                         ...
                         nifCandidatos (array|null) e fornecedorMatchVia
                         ('nif'|'nome'|'manual'|null); as faturas antigas não os têm
                         e todo o código aguenta a ausência. RECONCILIAÇÃO RETROATIVA
